package br.dio.com.java.io.IOData;
...
public class ExemploIODataComentado {
    public static void incluirProduto() throws IOException, EOFException {
        File f = new File("C:\\Users\\Naldo\\BOTCAMPS AMDOCS\\Entrada e Saída de Arquivos (IO) em Java/roupas.bin"); //utilizada para apontar arquivos ou diretórios.
